    ...
    if (!data && !error) {
      ...
      return (
        <div className='text-white text-justify'>
          ...
          <div className='text-large font-semibold flex items-center second:text-4xl third:text-5xl'>  {data.main.temp}°C    <img src={`/assets/${icon(data.weather[0].id)}.png`}/> </div>
